...
<head>
  ...
  if (mobileno.length != 10 || isNaN(mobileno)) {
				alert("Please enter a 10-digit mobile number with digits only.");
				return false;
			}
  else{
    return true;
            ...
            <div class="section group">
                ...
                <div class="col span_2_of_3">
                    <div class="contact-form">
                        <h2>Contact Us</h2>
                        <form name="contactus" method="post" onSubmit="return validate();">
                            <div>
                                <span><label>NAME</label></span>
                                <span><input type="text" name="fullname" id="fullname" required value=""></span>
                            </div>
                            <div>
                                <span><label>E-MAIL</label></span>
                                <span><input type="email" name="emailid" required value=""></span>
                            </div>
                            <div>
                                <span><label>MOBILE.NO</label></span>
                                <span><input type="text" name="mobileno" id="mobileno" required value=""></span>
                            </div>
                            <div>
                                <span><label>Description</label></span>
                                <span><textarea name="description" rows=11 cols=50 maxlength=250  required></textarea></span>
                            </div>
